    ...
    <div class="flex flex-col justify-center items-center gap-y-2 py-4 h-full">
      ...
      <div class="flex flex-col justify-between h-full">
        <div class="flex flex-col gap-y-2 py-4">
          <div v-for="(item, index) in menuItems.filter(el => el.visible)" :key="index" class="inline-block">
        ...
        <client-only>
          <div :title="authStore.user?.email || ''" class="flex items-center justify-center cursor-pointer">
